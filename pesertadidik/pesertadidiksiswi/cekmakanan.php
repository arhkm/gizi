<?php 
    ...
    @$where = "id = '$_GET[id]'";
    @$where1 = "nis = '$nama1'";
    $redirect = "hal_pesertadidik.php?page=hasil";
    $redirectt = "hal_pesertadidik.php?page=cekmakanan";
...
<div class="row" style="margin-top:4%;">
       ...
       <?php 
           ...
           <tr>
             ...
             <td><?php echo $r[6] ?></td>
             <td >
                <a href="hal_pesertadidik.php?page=cekmakanan&hapus&id=<?php echo $r[0] ?>" onClick="return confirm('Hapus Menu <?php echo $r[1]; ?> ?')" class=" tooltipped" data-position="bottom" data-delay="50" data-tooltip="Hapus">
