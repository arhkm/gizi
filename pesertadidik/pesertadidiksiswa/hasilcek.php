...
<!-- <a name="coba" type="submit" class="wavest-effect wavest-light btn red">SELESAI</a> -->
<div class="row" style="margin-top:50px;">
        ...
        <div class="col s12 m7">
          ...
          <div class="row">
            <div class="col s5 m6">
            <div class="card-content white-text">
              <span class="card-title " >Kebutuhan tubuh</span>
              <ul>
            ...
            <div class="row">
              ...
              <div class="card-content " style="margin-top:-40px;">
                <span class="card-title" style="color:white;"><center>Keterangan</center></span>
                  <div class="col s12 m12">
