...
session_start();
 ...
 <body>
    ...
    <div class="nav-wrapper  cyan darken-4">
      <a href="#" class=" left">INI LOGO</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <!-- <li><a href="hal_pesertadidiks.php?page=cekkebutuhantubuh">Cek Kebutuhan tubuh</a></li> -->
        <!-- <li><a href="hal_pesertadidiks.php?page=cekmakanan">Cek makanan</a></li> -->
        <!-- <li><a href="hal_pesertadidiks.php?page=hasil">Hasil</a></li> -->
 ...
 <div class="row">
  	<div class="col s12">
          ...
          case 'hasil':include 'hasilcek.php';break;
